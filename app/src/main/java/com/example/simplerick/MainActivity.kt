...
import com.example.simplerick.screens.AllEpisodesScreen
...
import com.example.simplerick.screens.SearchScreen
...
class MainActivity : ComponentActivity() {
    ...
    private fun NavigationHost(
        navController: NavHostController, ktorClient: KtorClient, innerPadding: PaddingValues
    ) {
        NavHost(
            navController = navController,
